  ...
  return (
    <section id='kontakt' className='bg-white'>
      ...
      <div className='container mx-auto mb-20'>
        <div className='row flex justify-center items-center flex-col xl:flex-row'>
          <div className='flex items-center'>
            <h3 className='text-2xl font-bold font-poppins'>tu nás nájdete</h3>
          </div>
          <div className='flex items-center mx-5 my-10 xl:my-0'>
        ...
        <div className='row flex justify-center flex-wrap'>
          <Slide left>
            <div className='w-full xl:w-1/2 flex justify-center items-center'>
              <div className='mx-5 xl:mx-16 my-20 max-w-lg bg-primary rounded-md shadow-xl hover:shadow-2xl transition-shadow flex flex-col'>
